...
class ChooserThemeViewModel: ViewModel() {
    ...
    val themes: ArrayList<Theme> = arrayListOf(
        ...
        Theme(0, "theme 2 title/title", "theme 2 info", EnglishLevel.BEGINNER, Status.THEORY, 0, 5, 10),
        Theme(0, "theme 3 title/title", "theme 3 info", EnglishLevel.BEGINNER, Status.THEORY, 0, 5, 10)
    )
