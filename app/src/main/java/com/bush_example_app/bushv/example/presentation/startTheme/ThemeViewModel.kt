...
import com.bush_example_app.bushv.example.domain.ExampleCollection
import com.bush_example_app.bushv.example.domain.InputChecker
...
class ThemeViewModel(val theme: Theme) : ViewModel() {
    ...
    fun sentenceRU(): String = currentExample.sentenceRU
